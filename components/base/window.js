...
export class WindowMainScreen extends Component {
    ...
    render() {
        return (
            <div className={"w-full flex-grow z-20 h-full min-h-0 max-h-full overflow-y-auto flex flex-col windowMainScreen" + (this.state.setDarkBg ? " bg-ub-drk-abrgn " : " bg-ub-cool-grey")}>
                {this.props.addFolder ? displayTerminal(this.props.addFolder, this.props.openApp) : this.props.screen(this.props.isMaximized)}
            </div>
        )
    }
}